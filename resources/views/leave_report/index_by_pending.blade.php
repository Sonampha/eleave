...
@section('content')
<div class="container">
    <h4 class="grey-text text-darken-2 center">Pending Leaves</h4>    
    {{-- Search --}}
    <div class="card-panel">
        <div class="row mb-0">
            <form action="report_pending" method="POST">
            @csrf()
    ...
    <div class="row">
        ...
        <div class="card col s12 m12 l12 xl12">
            <div class="card-content">
                <div class="row">
                    <h5 class="pl-15 grey-text text-darken-2">List of Pending Records</h5>
