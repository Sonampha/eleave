    ...
    <div class="container">
        <div class="row">
            <div class="card col s12 m12 l12 xl12 mt-20">
                <div>
                <h4 class="center grey-text text-darken-2 card-title">Update Holiday</h4>
                </div>
                <hr>
                    ...
                    <form action="{{route('holidays.update',$holiday->id)}}" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="input-field col s12 m8 offset-m2 l8 offset-l2 xl8 offset-xl2">
                                ...
                                <input type="text" name="year" id="year" value="{{Request::old('year') ? : $holiday->year }}">
                                <label for="year">Year</label>
                                <span class="{{$errors->has('year') ? 'helper-text red-text' : ''}}">{{$errors->first('year')}}</span>
                            </div>
                            <div class="input-field col s12 m8 offset-m2 l8 offset-l2 xl8 offset-xl2">
                                <i class="material-icons prefix">person_outline</i>
                                <input type="text" name="hol_name" id="hol_name" value="{{Request::old('hol_name') ? : $holiday->hol_name }}">
                            ...
                            <div class="input-field col s12 m8 offset-m2 l8 offset-l2 xl8 offset-xl2">
                                ...
                                <input type="number" name="day_off" id="day_off" value="{{Request::old('day_off') ? : $holiday->day_off }}">
                                <label for="day_off">Day Off</label>
                                <span class="{{$errors->has('day_off') ? 'helper-text red-text' : ''}}">{{$errors->first('day_off')}}</span>
                            </div>
                            <div class="input-field col s12 m8 offset-m2 l8 offset-l2 xl8 offset-xl2">
                                <i class="material-icons prefix">date_range</i>
                                <input type="text" name="date_from" id="date_from" class="datepicker" value="{{Request::old('date_from') ? : $holiday->date_from}}">
                                <label for="date_from">From</label>
                                <span class="{{$errors->has('date_from') ? 'helper-text red-text' : ''}}">{{$errors->has('date_from') ? $errors->first('date_from') : '' }}</span>
                            </div>
                            <div class="input-field col s12 m8 offset-m2 l8 offset-l2 xl8 offset-xl2">
                                <i class="material-icons prefix">date_range</i>
                                <input type="text" name="date_to" id="date_to" class="datepicker" value="{{Request::old('date_to') ? : $holiday->date_to}}">
