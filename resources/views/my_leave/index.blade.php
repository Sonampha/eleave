...
<div class="container">
    <h4 class="grey-text text-darken-2 center">My Leaves</h4>
                                ...
                                @foreach($leave_records as $leave_record)
                                    <tr>                                        
                                        ...
                                        <td>
                                            <div class="row mb-0">
                                                <div class="col">
                                                    <a href="{{route('my_leaves.show',$leave_record->id)}}" class="btn btn-small btn-floating waves=effect waves-light teal lighten-2" title="Details"><i class="material-icons">list</i></a>
                                                </div>
