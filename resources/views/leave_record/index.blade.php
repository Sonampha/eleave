...
<div class="container">
    ...
    <div class="card-panel">
        <div class="row mb-0">
            <form action="leave_records" method="POST">
            @csrf()
                                    ...
                                    <tr>                                        
                                        ...
                                        <td>
                                            <div class="row mb-0">
                                                ...
                                                <div class="col">
                                                    <a href="{{route('leave_records.edit',$leave_record->id)}}" class="btn btn-floating btn-small waves=effect waves-light orange" title="Edit"><i class="material-icons">mode_edit</i></a>
                                                </div>
                                                @endif
                                                @if(Auth::user()->user_type == "WEB")                                               
                                                <div class="col">
                                                    <form onsubmit="return confirm('Do you really want to DELETE?');" action="{{route('leave_records.destroy',$leave_record->id)}}" method="POST">
                                                        @method('DELETE')
                                                        @csrf()
