                ...
                <div class="input-field col s10 offset-s1 m4 l4 xl3">
                    <select name="department" id="department">
                        ...
                        @foreach($departments as $department)
                            <option value="{{$department->id}}" {{ old('department') == $department->id ? 'selected' : '' }} >{{$department->dept_name}}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="input-field col s10 offset-s1 m4 l4 xl3">
                    <select name="leave_type" id="leave_type">
                        ...
                        @foreach($leave_types as $leave_type)
                            <option value="{{$leave_type->leave_type}}" {{ old('leave_type') == $leave_type->leave_type ? 'selected' : '' }} >{{$leave_type->leave_type}}
                        </option>
                        @endforeach
                    </select>
