...
@section('content')
<div class="container">
    <h4 class="grey-text text-darken-2 center">Leave by Date</h4>    
    {{-- Search --}}
    <div class="card-panel">
        <div class="row mb-0">
            <form action="leave_by_date" method="POST">
            @csrf()
    ...
    <div class="row">
        ...
        <div class="card col s12 m12 l12 xl12">
            <div class="card-content">
                <div class="row">
                    <a href="{{ url('leaves/export_pdf/pdf') }}" class="btn cyan darken-4" style="text-transform: capitalize;">Export PDF</a>
                    <a href="{{ url('leaves/export_excel/xlsx') }}" class="btn cyan darken-4" style="text-transform: capitalize;">Export Excel</a>
                    <a href="{{ url('leaves/export_csv/csv') }}" class="btn cyan darken-4" style="text-transform: capitalize;">Export CSV</a> 
