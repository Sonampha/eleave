...
<div class="container">      
    ...
    <a href="/leaves/report/xlsx?staff_id={{$leave_record->staff_id}}&type={{$leave_record->leave_type}}" class="btn cyan darken-4" style="text-transform: capitalize;">Export Excel</a>
