        ...
        <div class="row">
            <div class="card col s12 m12 l12 xl12 mt-20">
                ...
                <div class="card-content">
                    <form action="{{route('leave_records.update',$leave_record->id)}}" method="POST" enctype="multipart/form-data">
                        <div class="row">
                           ...
                           <div class="input-field col s12 m8 offset-m2 l8 offset-l2 xl8 offset-xl2">
                            ...
                            <div class="input-field col s12 m8 offset-m2 l8 offset-l2 xl8 offset-xl2">
                                ...
                                <select name="status">
                                    ...
                                    <option value="Cancelled" {{ $leave_record->status=="Cancelled" ? 'selected' : '' }}>Cancelled</option>
                ...
                <div class="card-action">
                    <a href="/leaves/leave_records">Go Back</a>
                </div>
            </div>
        </div>
    </div>
