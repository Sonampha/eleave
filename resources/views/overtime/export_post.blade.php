...
<div class="container">
    ...
    <div class="row">
        ...
        <a href="/overtime/export/xlsx?funct={{$function_id}}&loc={{$location_id}}&from={{$date_from}}&to={{$date_to}}" class="btn cyan darken-4" style="text-transform: capitalize;">Export Excel</a>
        <a href="/overtime/export/csv?funct={{$function_id}}&loc={{$location_id}}&from={{$date_from}}&to={{$date_to}}" class="btn cyan darken-4" style="text-transform: capitalize;">Export CSV</a>
        <a href="/overtime/export/pdf?funct={{$function_id}}&loc={{$location_id}}&from={{$date_from}}&to={{$date_to}}" class="btn cyan darken-4" style="text-transform: capitalize;">Export PDF</a>
