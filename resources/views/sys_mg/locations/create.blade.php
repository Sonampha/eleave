    ...
    <div class="container">
        <div class="row">
            <div class="card col s12 m8 offset-m2 l8 offset-l2 xl8 offset-xl2 card-mt-15">
                <h4 class="center grey-text text-darken-2 card-title">Add Location</h4>
                <div class="card-content">
                    <div class="row">
                        <form action="{{route('locations.store')}}" method="POST">
                            <div class="input-field no-margin">
                                <i class="material-icons prefix">place</i>
                                <input type="text" name="location_name" id="location_name" class="validate" value="{{ Request::old('location_name') ? : '' }}">
                            ...
                            <div class="input-field">
                                <i class="material-icons prefix">place</i>
                                <input type="text" name="nick_name" id="nick_name" class="validate" value="{{ Request::old('nick_name') ? : '' }}">
                                <label for="nick_name">Nick Name</label>
                                <span class="{{$errors->has('nick_name') ? 'helper-text red-text' : '' }}">{{$errors->first('nick_name')}}</span>
                            </div>
                            <div class="input-field">
                                <i class="material-icons prefix">account_balance</i>
                                <input type="text" name="location_address" id="location_address" class="validate" value="{{ Request::old('location_address') ? : '' }}">
