    ...
    <div class="container">
        <div class="row">
            <div class="card col s12 m8 offset-m2 l8 offset-l2 xl8 offset-xl2 card-mt-15">
                <h4 class="center grey-text text-darken-2 card-title">Update Nationality</h4>
                <div class="card-content">
                    <div class="row">
                        <form action="{{route('nationalities.update',$nationality->id)}}" method="POST">
                            <div class="input-field no-margin">
                            <i class="material-icons prefix">location_on</i>
                                <input type="text" name="country_name" id="country_name" value="{{Request::old('country_name') ? : $nationality->country_name}}">
                    ...
                    <div class="card-action">
                        <a href="/nationalities">Go Back</a>
                    </div>
                </div>
            </div>
        </div>
