...
@section('content')
<div class="container">
    <h4 class="grey-text text-darken-2 center">My Attendances</h4>
    ...
    <div class="row">
        ...
        <div class="card col s12 m12 l12 xl12">
            <div class="card-content">
                <div class="row">
                    <h5 class="pl-15 grey-text text-darken-2">List of Attendance Records</h5>
                                ...
                                @foreach($attendance_problems as $attendance_problem)
                                    <tr>                                        
                                        ...
                                        <td>
                                            <div class="row mb-0">
                                                <div class="col">
                                                    <a href="{{route('my_attendances.show',$attendance_problem->id)}}" class="btn btn-small btn-floating waves=effect waves-light teal lighten-2" title="Details"><i class="material-icons">list</i></a>
                                                </div>
