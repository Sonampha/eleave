        ...
        <div class="row">
            <div class="card col s12 m12 l12 xl12 mt-20">
                ...
                <div class="card-content">
                    <form action="{{route('in_leu_records.update',$in_leu->id)}}" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="input-field col s12 m8 offset-m2 l8 offset-l2 xl8 offset-xl2">
                                <i class="material-icons prefix">date_range</i>
                                <input type="text" name="inleu_date" id="inleu_date" class="datepicker" value="{{Request::old('inleu_date') ? : $in_leu->inleu_date}}">
                                <label for="inleu_date">From</label>
                                <span class="{{$errors->has('inleu_date') ? 'helper-text red-text' : ''}}">{{$errors->has('inleu_date') ? $errors->first('inleu_date') : '' }}</span>
                            </div>
                            <div class="input-field col s12 m8 offset-m2 l8 offset-l2 xl8 offset-xl2">
                                <i class="material-icons prefix">person_outline</i>
                                <input disabled type="text" name="staff_name" id="staff_name" value="{{$in_leu->staff_name }}">
                                <label for="staff_name">Staff Name</label>
                            </div>
                            <div class="input-field col s12 m8 offset-m2 l8 offset-l2 xl8 offset-xl2">
                                <i class="material-icons prefix">person_outline</i>
                                <input type="text" name="staff_id" id="staff_id" value="{{Request::old('staff_id') ? : $in_leu->staff_id }}">
                            ...
                            <div class="input-field col s12 m8 offset-m2 l8 offset-l2 xl8 offset-xl2">
                                ...
                                <input type="number" name="inleu_day" id="inleu_day" min="0" max="90" step="0.5" value="{{Request::old('inleu_day') ? : $in_leu->inleu_day }}">
                                <label for="inleu_day">Day Off</label>
                                <span class="{{$errors->has('inleu_day') ? 'helper-text red-text' : ''}}">{{$errors->first('inleu_day')}}</span>
                            </div>
                            <div class="input-field col s12 m8 offset-m2 l8 offset-l2 xl8 offset-xl2">
                                <i class="material-icons prefix">edit</i>
                                <input type="text" name="reason" id="reason" value="{{Request::old('reason') ? : $in_leu->reason }}">
                ...
                <div class="card-action">
                    <a href="/inleus/in_leu_records">Go Back</a>
                </div>
            </div>
        </div>
    </div>
