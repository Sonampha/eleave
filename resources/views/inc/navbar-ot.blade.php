    ...
    <nav class="gradient-bg">
        <div class="container">
            <div class="nav-wrapper">
                <a href="{{route('dashboard')}}" class="brand-logo hide-on-small-only">HR Management System - O.T</a>
                <a href="{{route('dashboard')}}" class="brand-logo show-on-small-only hide-on-med-and-up">HR Management System - O.T</a>
                <ul>
