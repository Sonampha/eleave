        ...
        <div class="row">
            <div class="card col s12 m12 l12 xl12 mt-20">
                ...
                <div class="card-content">
                    <form action="{{route('my_att_tasks.update',$attendance_problem->id)}}" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="input-field col s12 m8 offset-m2 l8 offset-l2 xl8 offset-xl2">
                                <i class="material-icons prefix">person_outline</i>
                                <input type="text" name="staff_name" id="staff_name" value="{{Request::old('staff_name') ? : $attendance_problem->staff_name }}">
